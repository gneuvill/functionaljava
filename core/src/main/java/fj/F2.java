...
public interface F2<A, B, C> {
   ...
   */
  public F<B, C> f(final A a) default {
    return new F<B, C>() {
   ...
   */
  public F<A, F<B, C>> curry() default {
   ...
   */
  public F<P2<A, B>, C> tuple() default {
   ...
   */
  public F2<Array<A>, Array<B>, Array<C>> arrayM() default {
   ...
   */
  public F2<Promise<A>, Promise<B>, Promise<C>> promiseM() default {
   ...
   */
  public F2<Iterable<A>, Iterable<B>, IterableW<C>> iterableM() default {
   ...
   */
  public F2<List<A>, List<B>, List<C>> listM() default {
   ...
   */
  public F2<NonEmptyList<A>, NonEmptyList<B>, NonEmptyList<C>> nelM() default {
   ...
   */
  public F2<Option<A>, Option<B>, Option<C>> optionM() default {
   ...
   */
  public F2<Set<A>, Set<B>, Set<C>> setM(final Ord<C> o) default {
   ...
   */
  public F2<Stream<A>, Stream<B>, Stream<C>> streamM() default {
   ...
   */
  public F2<Tree<A>, Tree<B>, Tree<C>> treeM() default {
   ...
   */
  public F2<Array<A>, Array<B>, Array<C>> zipArrayM() default {
    return new F2<Array<A>, Array<B>, Array<C>>() {
   ...
   */
  public F2<Iterable<A>, Iterable<B>, Iterable<C>> zipIterableM() default {
   ...
   */
  public F2<List<A>, List<B>, List<C>> zipListM() default {
    return new F2<List<A>, List<B>, List<C>>() {
   ...
   */
  public F2<Stream<A>, Stream<B>, Stream<C>> zipStreamM() default {
    return new F2<Stream<A>, Stream<B>, Stream<C>>() {
      public Stream<C> f(final Stream<A> as, final Stream<B> bs) {
        return as.zipWith(bs, F2.this);
      }
   ...
   */
  public F2<NonEmptyList<A>, NonEmptyList<B>, NonEmptyList<C>> zipNelM() default {
    return new F2<NonEmptyList<A>, NonEmptyList<B>, NonEmptyList<C>>() {
      public NonEmptyList<C> f(final NonEmptyList<A> as, final NonEmptyList<B> bs) {
   ...
   */
  public F2<Set<A>, Set<B>, Set<C>> zipSetM(final Ord<C> o) default {
    return new F2<Set<A>, Set<B>, Set<C>>() {
      public Set<C> f(final Set<A> as, final Set<B> bs) {
   ...
   */
  public F2<Tree<A>, Tree<B>, Tree<C>> zipTreeM() default {
    return new F2<Tree<A>, Tree<B>, Tree<C>>() {
   ...
   */
  public F2<Zipper<A>, Zipper<B>, Zipper<C>> zipZipperM() default {
   ...
   */
  public F2<TreeZipper<A>, TreeZipper<B>, TreeZipper<C>> zipTreeZipperM() default {
