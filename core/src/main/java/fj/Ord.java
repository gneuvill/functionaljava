...
public final class Ord<A> {
  ...
  public Equal<A> equal() {
    return Equal.equal(curry((final A a1, final A a2) -> eq(a1, a2)));
  }
   ...
   */
  public final F<A, F<A, A>> max = curry((final A a, final A a1) -> max(a, a1));

  /**
   * A function that returns the lesser of its two arguments.
   */
  public final F<A, F<A, A>> min = curry((final A a, final A a1) -> min(a, a1));
   ...
   */
  public static final Ord<Boolean> booleanOrd = new Ord<>(
          a1 -> new F<Boolean, Ordering>() {
   ...
   */
  public static final Ord<Byte> byteOrd = new Ord<>(
          a1 -> new F<Byte, Ordering>() {
   ...
   */
  public static final Ord<Character> charOrd = new Ord<>(
          a1 -> new F<Character, Ordering>() {
   ...
   */
  public static final Ord<Double> doubleOrd = new Ord<>(
          a1 -> a2 -> {
            final int x = a1.compareTo(a2);
            return x < 0 ? Ordering.LT : x == 0 ? Ordering.EQ : Ordering.GT;
          });
   ...
   */
  public static final Ord<Float> floatOrd = new Ord<>(
          a1 -> a2 -> {
            final int x = a1.compareTo(a2);
            return x < 0 ? Ordering.LT : x == 0 ? Ordering.EQ : Ordering.GT;
          });
   ...
   */
  public static final Ord<Integer> intOrd = new Ord<>(
          a1 -> new F<Integer, Ordering>() {
   ...
   */
  public static final Ord<BigInteger> bigintOrd = new Ord<>(
          a1 -> a2 -> {
            final int x = a1.compareTo(a2);
            return x < 0 ? Ordering.LT : x == 0 ? Ordering.EQ : Ordering.GT;
          });
   ...
   */
  public static final Ord<BigDecimal> bigdecimalOrd = new Ord<>(
          a1 -> new F<BigDecimal, Ordering>() {
   ...
   */
  public static final Ord<Long> longOrd = new Ord<>(
          a1 -> new F<Long, Ordering>() {
   ...
   */
  public static final Ord<Short> shortOrd = new Ord<>(
          a1 -> new F<Short, Ordering>() {
   ...
   */
  public static final Ord<Ordering> orderingOrd = new Ord<>(curry((final Ordering o1, final Ordering o2) -> o1 == o2 ?
         Ordering.EQ :
         o1 == Ordering.LT ?
         Ordering.LT :
         o2 == Ordering.LT ?
   ...
   */
  public static final Ord<String> stringOrd = new Ord<>(
          a1 -> new F<String, Ordering>() {
  ...
  public static final Ord<StringBuffer> stringBufferOrd =
      new Ord<>(a1 -> new F<StringBuffer, Ordering>() {
  ...
  public static final Ord<StringBuilder> stringBuilderOrd =
      new Ord<>(a1 -> a2 -> stringOrd.compare(a1.toString(), a2.toString()));
  ...
  public static <A> Ord<Option<A>> optionOrd(final Ord<A> oa) {
    return new Ord<>(o1 -> o2 -> o1.isNone() ?
           o2.isNone() ?
           Ordering.EQ :
           Ordering.LT :
           o2.isNone() ?
  ...
  public static <A, B> Ord<Either<A, B>> eitherOrd(final Ord<A> oa, final Ord<B> ob) {
    return new Ord<>(e1 -> new F<Either<A, B>, Ordering>() {
  ...
  public static <A> Ord<Set<A>> setOrd(final Ord<A> oa) {
    return streamOrd(oa).comap((final Set<A> as) -> as.toStream());
  }

  /**
   * An order instance for the {@link Unit} type.
   */
  public static final Ord<Unit> unitOrd = ord(curry((final Unit u1, final Unit u2) -> Ordering.EQ));
  ...
  public static <A> Ord<P1<A>> p1Ord(final Ord<A> oa) {
    return oa.comap(Product1.<A>__1());
  }
  ...
  public static <A, B> Ord<P2<A, B>> p2Ord(final Ord<A> oa, final Ord<B> ob) {
    return ord(curry((final P2<A, B> a, final P2<A, B> b) -> oa.eq(a._1(), b._1()) ? ob.compare(a._2(), b._2()) : oa.compare(a._1(), b._1())));
  }
  ...
  public static <A, B, C> Ord<P3<A, B, C>> p3Ord(final Ord<A> oa, final Ord<B> ob, final Ord<C> oc) {
    return ord(curry((final P3<A, B, C> a, final P3<A, B, C> b) -> oa.eq(a._1(), b._1()) ?
  ...
  public static <A> Ord<A> hashOrd() {
    return Ord.<A> ord(a -> new F<A, Ordering>() {
      @Override
