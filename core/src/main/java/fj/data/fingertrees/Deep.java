...
public final class Deep<V, A> extends FingerTree<V, A> {
  ...
  @Override public <B> FingerTree<V, B> map(final F<A, B> abf, final Measured<V, B> m) {
    return new Deep<>(m, v, prefix.map(abf, m), middle.map(Node.<V, A, B>liftM(abf, m), m.nodeMeasured()),
                          suffix.map(abf, m));
  }
  ...
  @Override public FingerTree<V, A> cons(final A a) {
    ...
    return prefix.match(one -> new Deep<>(m, measure, mk.two(a, one.value()), middle, suffix), two -> new Deep<>(m, measure, mk.three(a, two.values()._1(), two.values()._2()), middle, suffix), three -> new Deep<>(m, measure, mk.four(a, three.values()._1(), three.values()._2(),
                                              three.values()._3()), middle, suffix), four -> new Deep<>(m, measure, mk.two(a, four.values()._1()),
  ...
  public FingerTree<V, A> snoc(final A a) {
    ...
    final V measure = m.sum(m.measure(a), v);
    final MakeTree<V, A> mk = mkTree(m);
    return suffix.match(one -> new Deep<>(m, measure, prefix, middle, mk.two(one.value(), a)), two -> new Deep<>(m, measure, prefix, middle, mk.three(two.values()._1(), two.values()._2(), a)), three -> new Deep<>(m, measure, prefix, middle, mk.four(three.values()._1(), three.values()._2(),
                                                              three.values()._3(), a)), four -> new Deep<>(m, measure, prefix,
  ...
  @Override public FingerTree<V, A> append(final FingerTree<V, A> t) {
    final Measured<V, A> m = measured();
    return t.match(Function.<Empty<V, A>, FingerTree<V, A>>constant(t), single -> t.snoc(single.value()), deep -> new Deep<>(m, m.sum(measure(), deep.measure()), prefix,
  ...
  private static <V, A> FingerTree<V, Node<V, A>> addDigits0(final Measured<V, A> m, final FingerTree<V, Node<V, A>> m1,
    ...
    final MakeTree<V, A> mk = mkTree(m);
    return s1.match(one1 -> p2.match(new F<One<V, A>, FingerTree<V, Node<V, A>>>() {
  ...
  private static <V, A> FingerTree<V, Node<V, A>> append1(final Measured<V, A> m, final FingerTree<V, Node<V, A>> xs,
    ...
    return xs.match(empty -> ys.cons(a), single -> ys.cons(a).cons(single.value()), deep1 -> ys.match(new F<Empty<V, Node<V, A>>, FingerTree<V, Node<V, A>>>() {
  ...
  private static <V, A> FingerTree<V, Node<V, Node<V, A>>> addDigits1(final Measured<V, Node<V, A>> m,
    ...
    return x.match(one1 -> y.match(new F<One<V, Node<V, A>>, FingerTree<V, Node<V, Node<V, A>>>>() {
  ...
  private static <V, A> FingerTree<V, Node<V, A>> append2(final Measured<V, A> m, final FingerTree<V, Node<V, A>> t1,
    ...
    return t1.match(empty -> t2.cons(n2).cons(n1), single -> t2.cons(n2).cons(n1).cons(single.value()), deep -> t2.match(new F<Empty<V, Node<V, A>>, FingerTree<V, Node<V, A>>>() {
      public FingerTree<V, Node<V, A>> f(final Empty<V, Node<V, A>> empty) {
  ...
  private static <V, A> FingerTree<V, Node<V, Node<V, A>>> addDigits2(final Measured<V, Node<V, A>> m,
                                                                      ...
                                                                      final FingerTree<V, Node<V, Node<V, A>>> m2) {
    final MakeTree<V, Node<V, A>> mk = mkTree(m);
    return suffix.match(one -> prefix.match(new F<One<V, Node<V, A>>, FingerTree<V, Node<V, Node<V, A>>>>() {
      public FingerTree<V, Node<V, Node<V, A>>> f(final One<V, Node<V, A>> one2) {
  ...
  private static <V, A> FingerTree<V, Node<V, A>> append3(final Measured<V, A> m, final FingerTree<V, Node<V, A>> t1,
                                                          ...
                                                          final FingerTree<V, Node<V, A>> t2) {
    final Measured<V, Node<V, A>> nm = m.nodeMeasured();
    return t1.match(empty -> t2.cons(n3).cons(n2).cons(n1), single -> t2.cons(n3).cons(n2).cons(n1).cons(single.value()), deep -> t2.match(new F<Empty<V, Node<V, A>>, FingerTree<V, Node<V, A>>>() {
      public FingerTree<V, Node<V, A>> f(final Empty<V, Node<V, A>> empty) {
  ...
  private static <V, A> FingerTree<V, Node<V, Node<V, A>>> addDigits3(final Measured<V, Node<V, A>> m,
    ...
    }, three -> prefix.match(new F<One<V, Node<V, A>>, FingerTree<V, Node<V, Node<V, A>>>>() {
      public FingerTree<V, Node<V, Node<V, A>>> f(final One<V, Node<V, A>> one) {
