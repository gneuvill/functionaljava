...
public final class Doubles {
   ...
   */
  public static final F<Double, F<Double, Double>> subtract = curry((final Double x, final Double y) -> x - y);
   ...
   * Remainder.
   */
  public static final F<Double, F<Double, Double>> remainder = curry((final Double a, final Double b) -> a % b);

  /**
   * Power.
   */
  public static final F<Double, F<Double, Double>> power = curry((final Double a, final Double b) -> StrictMath.pow(a, b));
