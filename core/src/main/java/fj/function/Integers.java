...
public final class Integers {
   ...
   */
  public static final F<Integer, F<Integer, Integer>> subtract = curry((final Integer x, final Integer y) -> x - y);
   ...
   * Remainder.
   */
  public static final F<Integer, F<Integer, Integer>> remainder = curry((final Integer a, final Integer b) -> a % b);

  /**
   * Power.
   */
  public static final F<Integer, F<Integer, Integer>> power = curry((final Integer a, final Integer b) -> (int) StrictMath.pow(a, b));
