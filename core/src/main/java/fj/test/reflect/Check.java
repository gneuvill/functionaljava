...
public final class Check {
  ...
  public static <T> List<P2<String, CheckResult>> check(final List<java.lang.Class<T>> c, final Rand r, final String... categories) {
    return join(c.map((F<java.lang.Class<T>, List<P2<String, CheckResult>>>) c -> Check.check(c, r, categories)));
  }
  ...
  public static <T> List<P2<String, CheckResult>> check(final java.lang.Class<T> c, final Rand r, final String... categories) {
    return join(clas(c).inheritance().map((F<Class<? super T>, List<P3<Property, String, Option<CheckParams>>>>) c -> Check.properties(c.clas(), categories))).map((F<P3<Property, String, Option<CheckParams>>, P2<String, CheckResult>>) p -> {
      if(p._3().isSome()) {
  ...
  public static <U, T extends U> List<P3<Property, String, Option<CheckParams>>> properties(final java.lang.Class<T> c, final String... categories) {
    ...
    //noinspection ClassEscapesDefinedScope
    final Array<P3<Property, String, Option<CheckParams>>> propMethods = properties(array(c.getDeclaredMethods()).map((F<Method, PropertyMember>) m -> new PropertyMember() {
      public java.lang.Class<?> type() {
  ...
  private static <T> Array<P3<Property, String, Option<CheckParams>>> properties(final Array<PropertyMember> ms, final java.lang.Class<T> declaringClass, final String... categories) {
    final Option<T> t = emptyCtor(declaringClass).map((F<Constructor<T>, T>) ctor -> {
      try {
    ...
    final F<Name, String> nameS = name -> name.value();

    return ms.filter((F<PropertyMember, Boolean>) m -> m.isProperty() &&
        ...
        (t.isSome() || isStatic(m.modifiers()))).map((F<PropertyMember, P3<Property, String, Option<CheckParams>>>) m -> {
          try {
